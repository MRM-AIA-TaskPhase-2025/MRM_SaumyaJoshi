...
class IMUGUI(QWidget):
    ...
    def initUI(self):
        ...
        layout.setSpacing(10) #between widgets
        ...
        self.imu_label = QLabel('IMU Data will be displayed here.', self) #display image/text
        layout.addWidget(self.imu_label, alignment=Qt.AlignTop)
        
        layout.addSpacerItem(QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Fixed)) # width height hpolicy vpolicy 
    ...
    def update_video(self, data):
        try:
            cv_image = self.bridge.imgmsg_to_cv2(data, "bgr8") #image encoding format
